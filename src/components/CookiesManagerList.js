...
const headCells = [
  ...
  { id: 'is secure', numeric: false, disablePadding: false, label: 'Is Secure?' },
  { id: 'is persistent', numeric: false, disablePadding: false, label: 'Is Persistent?' },
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell>{String(row.is_secure)}</TableCell>
        <TableCell>{String(row.is_persistent)}</TableCell>
